...
const CreatePost = () => {
  ...
  const generateImage = async () => {
    if (form.prompt && form.resolution) {
      try {
        ...
        const response = await fetch('https://ai-generation-image.vercel.app/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      try {
        const response = await fetch('https://ai-generation-image.vercel.app/api/v1/post', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
